...
public class CreateProductBrand(
    IDbContextFactory<ProductsDbContext> _dbContextFactory,
    ...
    : IRequestHandler<CreateProductBrandInput, ProductBrand?>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        await using ProductsDbContext dbContext = await _dbContextFactory.CreateDbContextAsync(cancellationToken);
