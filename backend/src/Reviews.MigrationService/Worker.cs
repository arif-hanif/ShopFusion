...
namespace ShopFusion.Reviews.MigrationService;
    ...
    IHostApplicationLifetime hostApplicationLifetime) : BackgroundService
{
    ...
    private static async Task EnsureDatabaseAsync(ReviewsDbContext dbContext, CancellationToken cancellationToken)
    {
    ...
    private static async Task RunMigrationAsync(ReviewsDbContext dbContext, CancellationToken cancellationToken)
    {
        var strategy = dbContext.Database.CreateExecutionStrategy();
        await strategy.ExecuteAsync(async () =>
        {
